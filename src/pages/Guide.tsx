            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg p-4 shadow-md sticky top-4">
              ...
              <nav className="space-y-1">
                ...
                <div className="pl-4 border-l border-gray-200 dark:border-gray-700 ml-2 mt-1">
                  {steps.map((step, index) => <a key={index} href={`#step-${index + 1}`} className="block py-1 px-2 rounded hover:bg-gray-100 dark:hover:bg-gray-700 text-sm transition-colors" onClick={e => {
                  e.preventDefault();
